  ...
  <div class="container">
    ...
    <div class="row row-cols-3 mb-5 justify-content-start">
      ...
      <div class="col">
        ...
        <AVBars :src="audioSrc" caps-color="#FFF" :bar-color="['#f00', '#ff0', '#0f0']" canv-fill-color="#000"
          :brick-height="6" :bar-width="10" :caps-height="2" />
      </div>
      <div class="col">
        <h3><code>&lt;AVCircle&gt;</code></h3>
        <div class="d-flex align-items-center">
          <AVCircle :src="audioSrc" :outline-width="0.5" :progress-width="5" :outline-meter-space="4" :playtime="true"
      ...
      <div class="col">
        ...
        <div v-show="showMedia" class="row row-cols-2">
          <div class="col">
            ...
            <AVMedia :media="stream" type="frequ" frequ-direction="mo" :frequ-lnum="60" line-color="darkorange" />
          ...
          <div class="col">
            ...
            <AVMedia :media="stream" :canv-width="30" :canv-height="30" type="frequ" :frequ-line-cap="true"
              :frequ-lnum="3" :line-width="6" />
